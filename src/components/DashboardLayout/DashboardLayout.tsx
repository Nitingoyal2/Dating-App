...
const screenToRoute: Record<DashboardScreen, string> = {
  ...
  [DashboardScreenEnum.EDIT]: Routes.EDIT,
};
    ...
    switch (activeScreen) {
      ...
      case DashboardScreenEnum.PROFILE:
        return (
          <Profile
            onSettingsClick={() =>
              handleScreenChange(DashboardScreenEnum.SETTINGS)
            }
            onEditProfileClick={() =>
              handleScreenChange(DashboardScreenEnum.EDIT)
            }
          />
        );
      ...
      <div className="dashboard-footer">
        ...
        >
          <ChatIcon
            size={24}
            color={
              activeScreen === DashboardScreenEnum.CHAT ? "#E94057" : "#ADAFBB"
            }
          />
        </button>
        <button
