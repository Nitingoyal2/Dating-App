...
export const FilterIcon = ({ size = 24, color = 'currentColor', ...props }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path fillRule="evenodd" clipRule="evenodd" d="M7.9998 9.12386C6.82782 9.12386 5.87598 8.17076 5.87598 7.00003C5.87598 5.82805 6.82782 4.8762 7.9998 4.8762C9.17179 4.8762 10.1236 5.82805 10.1236 7.00003C10.1236 8.17076 9.17179 9.12386 7.9998 9.12386ZM8 3C5.79362 3 4 4.79362 4 7C4 9.20513 5.79362 11 8 11C10.2064 11 12 9.20513 12 7C12 4.79362 10.2064 3 8 3Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M15.9998 14.8762C17.1718 14.8762 18.1236 15.8293 18.1236 17C18.1236 18.1708 17.1718 19.1239 15.9998 19.1239C14.8291 19.1239 13.876 18.1708 13.876 17C13.876 15.8293 14.8291 14.8762 15.9998 14.8762ZM16 21C18.2064 21 20 19.2051 20 17C20 14.7949 18.2064 13 16 13C13.7949 13 12 14.7949 12 17C12 19.2051 13.7949 21 16 21Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M21.1175 16C21.6046 16 21.9998 16.448 21.9998 17C21.9998 17.552 21.6046 18 21.1175 18H19V16H21.1175ZM13 16V18L2.88234 18C2.39529 18 2 17.552 2 17C2 16.448 2.39529 16 2.88234 16H13Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M11 6H21.1163C21.6034 6 21.9987 6.448 21.9987 7C21.9987 7.552 21.6034 8 21.1163 8H11V6ZM5 6H2.88234C2.39529 6 2 6.448 2 7C2 7.552 2.39529 8 2.88234 8H5V6Z" fill={color} />
    </svg>
)
