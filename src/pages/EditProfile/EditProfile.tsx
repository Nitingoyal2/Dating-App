  ...
  useEffect(() => {
    function handleOutside(e: MouseEvent) {
      if (
        ...
        !schoolWrapperRef.current.contains(e.target as Node)
      ) {
  ...
  const renderBasicField = (item: EditProfileItem) => {
    switch (item) {
      ...
      case EditProfileItem.SCHOOL:
        return (
          <div className="edit-profile-field" ref={schoolWrapperRef}>
            <label className="edit-profile-field-label">School</label>
